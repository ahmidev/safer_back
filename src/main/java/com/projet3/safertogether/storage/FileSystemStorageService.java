...
public class FileSystemStorageService implements StorageService {
    ...
    public Resource loadAsResource(String filename) throws StorageFileNotFoundException {
        if (!fileNameExistsInDatabase(filename)) {
            throw new StorageFileNotFoundException("File not found in the database: " + filename);
        }
    ...
    public boolean fileNameExistsInDatabase(String filename) {
